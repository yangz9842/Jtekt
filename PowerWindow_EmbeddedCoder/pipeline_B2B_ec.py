...
############################################
print("Step 2 model {} EC model import".format(MODELNAME))
start = time.time()

print(WORKSPACE + MODELNAME)
EC_import_payload = {
  "ecModelFile": WORKSPACE + MODELNAME,
  "ecInitScript": WORKSPACE + SCRIPTNAME,
  }



response = ep.post('architectures/embedded-coder', EC_import_payload)
